...
export const logo = {
  "_note": "Geometry in the file's own 667×540 coordinate space. The production vector, not a redraw — the only edit from the supplied file is black → currentColor so the mark inverts on dark surfaces.",
  "aspect": 1.2352,
  "viewBox": {
    "width": 667,
    "height": 540
